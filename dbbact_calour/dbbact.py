...
class DBBact(Database):
    ...
    def enrichment(self, exp, features, bg_features=None, max_id=None, term_type='term', **kwargs):
        ...
        **kwargs: additional parameters supplied to db_access.term_enrichment(). These include:
        ...
        res = self.db.term_enrichment(g1_features=features, g2_features=bg_features, all_annotations=exp.databases['dbbact']['annotations'].copy(), seq_annotations=exp.databases['dbbact']['sequence_annotations'].copy(), term_info=exp.databases['dbbact'].get('term_info'), term_type=term_type, **kwargs)
        return res

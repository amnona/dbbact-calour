...
copyright = '2016-2018, dbbact development team'
...
# version = dbbact_calour.__version__
# # The full version, including alpha/beta/rc tags.
# release = dbbact_calour.__version__
...
htmlhelp_basename = 'dbbactcalourdoc'
...
latex_documents = [
  ('index', 'dbbact-calour.tex', 'dbbact-calour Documentation',
   'dbbact development team', 'manual'),
]
...
man_pages = [
    ('index', 'dbbact-calour', 'dbbact-calour Documentation',
     ['dbbact development team'], 1)
]
...
texinfo_documents = [
  ('index', 'dbbact-calour', 'dbbact-calour Documentation',
   'dbbact development team', 'dbbact-calour',
...
def linkcode_resolve(domain, info):
    ...
    # fn = relpath(fn, start=dirname(dbbact_calour.__file__))

    # if 'dev' in dbbact_calour.__version__:
    #     return "https://github.com/amnona/dbbact-calour/blob/master/dbbact_calour/%s%s" % (fn, linespec)
    # else:
    #     return "https://github.com/amnona/dbbact-calour/blob/%s/dbbact_calour/%s%s" % (dbbact_calour.__version__, fn, linespec)
    return "https://github.com/amnona/dbbact-calour/blob/%s/dbbact_calour/%s%s" % (version, fn, linespec)
